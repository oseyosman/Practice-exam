...
const CYSA_QUESTIONS = [
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "Root cause analysis (RCA) is the action an analyst would most likely perform after an incident has\nbeen investigated. RCA is a structured post-incident process used to identify the fundamental,\nunderlying cause(s) of an incident — not just the symptoms. It is a key component of the\npost-incident activity phase of the incident response lifecycle (Preparation → Detection & Analysis →\nContainment, Eradication & Recovery → Post-Incident Activity). After the investigation concludes,\nRCA helps the team understand why the incident occurred, how to prevent recurrence, and what\nimprovements to make to controls, processes, or configurations.\n\nThe other options are not post-incident actions:\n- Risk assessment (A) is performed before incidents to identify and evaluate potential risks to the\norganization.\n- Incident response plan (C) is developed and maintained before incidents occur as part of the\nPreparation phase.\n- Tabletop exercise (D) is a simulation exercise performed as part of incident response preparedness\ntraining — it is a pre-incident activity, not something done after a real incident investigation.\n\nReference: NIST SP 800-61 Rev. 2 - Computer Security Incident Handling Guide, Post-Incident\nActivity section; Root Cause Analysis - OWASP; CompTIA CySA+ Study Guide Exam CS0-003",
    "image": null
  },
  {
    "id": "q-jc-244",
